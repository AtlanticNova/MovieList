    ...
    <div class="container-fluid text-white gx-0" style="background-color:black;">
                    ...
                    <div class="card bg-dark text-white mb-2" style="width: 15rem;margin-left: 20px;">
                        ...
                        <div class="card-body">
                            <p class="card-text" style="transform: rotate(0);">
                                ...
                                <a href="/admin/movies/{{$p->id}}" class=" text-white stretched-link"></a>
                            </p>
                        </div>
                    </div>
                @endforeach
        ...
        <div class="p-3">
            ...
            <div class="d-flex justify-content-end p-3">
                <a href="/admin/addMovie" class="btn btn-danger">
                ...
                @foreach ($movies as $movie)
                    <div class="card bg-dark text-white mb-2" style="width: 15rem;margin-left: 20px;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="/admin/movies/{{$movie->id}}" class="stretched-link"></a>
                        </div>
                    </div>
                @endforeach
            </div>
