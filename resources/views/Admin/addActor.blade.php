...
@section('headline', 'Add Actor')

@section('content')
    <content>
        <div class="container-fluid" style="background-color:black; padding:57.5px">
            <div class="container">
                <h4 style="color:white;">Add Actor</h1>
                <form style="color: white; margin-top: 50px" method="POST" action="/admin/actors/addActors" enctype="multipart/form-data">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input type="text" class="form-control bg-dark text-white" id="name" name="name" style="border: none;">
                        @error('name')
                    ...
                    <div class="form-group mt-3 mb-3">
                        ...
                        <select class="form-select bg-dark text-white select2" id="gender" style="border: none;" name="gender">
                    ...
                    <div class="form group mt-3">
                        ...
                        <textarea class="form-control bg-dark text-white" id="biography" rows="3" style="border: none;" name="biography"></textarea>
                        @error('biography')
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input type="date" class="form-control bg-dark text-white" id="dob" name="dob" style="border: none;">
                        @error('dob')
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input type="text" class="form-control bg-dark text-white" id="pob" name="pob" style="border: none;">
                        @error('pob')
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input type="text" class="form-control bg-dark text-white" id="popularity" name="popularity" style="border: none;">
                        @error('popularity')
