...
@section('content')
    <content>
        <div style="height: 100vh; background-color:black; display:flex; flex-direction: row; align-items: center; justify-content:space-around"
            ...
            <div class="flex-shrink-0" style="max-width: 300px; text-align:center">
                ...
                <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    <img src="{{ asset('images/' . Auth::user()->imageURL) }}" class="rounded-circle mt-3 mb-3" alt="..."
                ...
                <form style="color: white; margin-top: 50px" method="POST" action="/profile/{{ Auth::user()->id }}"
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input type="text" class="form-control bg-dark text-white" id="phone" name="phone"
                            placeholder="Enter your Phone Number" style="border: none;" value={{ Auth::user()->phone }}>
                    </div>
        ...
        <div class="modal fade modal" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <form class="modal-dialog" method="POST" action="/profile/{{ Auth::user()->id }}"
                enctype="multipart/form-data">
                @csrf
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group mt-3">
                            ...
                            <div id="emailHelp" class="form-text">Please upload your image</div>
                        </div>
                    </div>
